...
class VrisingBot(SteamCmdBot):
    ...
    async def ip(self, message):
        ...
        await self.send_message(message, external_ip + ':27015')
    ...
    async def stop(self, message, direct_command="True"):
        ...
        returnval = subprocess.call(['C:/Program Files/AutoHotkey/v2/AutoHotkey64.exe', 'C:/steamcmd/steamapps/common/VRisingDedicatedServer/stop_server.ahk'])
        if returnval == 1:
